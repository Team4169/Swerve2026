...
class RotateArmToRobot(commands2.SequentialCommandGroup):
    """
    ...
    def __init__(self, climb: ClimbingSubsystem):
        super().__init__(
            ...
            MoveRotateArmPastLocation(constants.rotateArmCloseToRobotTicks, False, constants.rotateArmFastSpeed, climb),
